/* app/(admin)/admin/affiliate-products/new/page.js */
"use client";
...
/**
 * Extracts raw list or recursively flattens hierarchical tree categories into a single array
 * with correct level metadata for clear dropdown display.
 */
const parseCategories = (apiData) => {
  let items = [];
  ...
  if (Array.isArray(apiData)) {
    ...
    items = apiData.data;
  } else if (Array.isArray(apiData?.categories)) {
    items = apiData.categories;
  }
...
const NewAffiliateProductEditor = () => {
    ...
    const fetchReferences = async () => {
      try {
        ...
        const [categoriesRes, storesRes] = await Promise.all([
          fetch("/api/public/categories/module/product", { cache: "no-store" }),
        ...
        // Safely parse hierarchical or flat categories
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok || data?.success === false) {
        ...
        throw new Error(firstError || "Failed to create affiliate product.");
      }

      await Swal.fire({
        icon: "success",
        title: "Product created",
        text: data?.message || "Affiliate product created successfully.",
        confirmButtonColor: "#2D2380",
      });
      ...
      Swal.fire({
        icon: "error",
        title: "Create failed",
        text: error.message || "Failed to create affiliate product.",
        confirmButtonColor: "#E24B4A",
      });
    } finally {
            ...
            <div className="xl:col-span-2 space-y-6">
              ...
              <div className="bg-white border border-[#E0DEF5] rounded-xl p-6 shadow-[0_2px_12px_rgba(26,19,64,0.04)] space-y-5">
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-4">
                  <Tag size={18} className="text-[#2D2380]" /> Identity & Branding
                </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2">
                    ...
                    <input
                      ...
                      onBlur={generateSlug}
                      required
                      placeholder="e.g. Herman Miller Embody Ergonomic Chair"
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleBasicChange}
                      required
                      placeholder="herman-miller-embody-chair"
              ...
              <div className="bg-white border border-[#E0DEF5] rounded-xl p-6 shadow-[0_2px_12px_rgba(26,19,64,0.04)] space-y-5">
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-4">
                  <FileText size={18} className="text-[#2D2380]" /> Editorial Content
                </h2>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    required
                    placeholder="Brief overview for cards and meta listings..."
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleBasicChange}
                    rows={6}
                    placeholder="<p>Detailed breakdown of features, performance, and testing...</p>"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleBasicChange}
                      placeholder="e.g. Best Overall Ergonomics"
              ...
              <div className="bg-white border border-[#E0DEF5] rounded-xl p-6 shadow-[0_2px_12px_rgba(26,19,64,0.04)] space-y-5">
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-4">
                  <ListChecks size={18} className="text-[#2D2380]" /> Pros, Cons & Highlights
                </h2>
              ...
              <div className="bg-white border border-[#E0DEF5] rounded-xl p-6 shadow-[0_2px_12px_rgba(26,19,64,0.04)] space-y-5">
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-4">
                  <ImageIcon size={18} className="text-[#2D2380]" /> Media & Specifications
                </h2>
                    ...
                    {formData.images.map((img, idx) => (
                      ...
                      >
                        ...
                        <button
                          ...
                          className="absolute top-1 right-1 bg-[#E24B4A] text-white p-1 rounded-full opacity-0 group-hover:opacity-100 transition-opacity shadow-sm"
                        >
                          <X size={12} />
                        </button>
                      </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-[#2D2380] rounded-xl p-6 shadow-lg space-y-4 relative overflow-hidden">
                ...
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-3 mb-2">
                  <DollarSign size={18} className="text-[#2D2380]" /> Pricing & Links
                </h2>

                <div>
                  <label className="block text-[13px] font-semibold text-[#1A1340] mb-1.5">
                    Affiliate Redirect URL <span className="text-[#E24B4A]">*</span>
                  </label>
              ...
              <div className="bg-white border border-[#E0DEF5] rounded-xl p-6 shadow-[0_2px_12px_rgba(26,19,64,0.04)] space-y-4">
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-3 mb-2">
                  <Settings size={18} className="text-[#2D2380]" /> Taxonomy & Setup
                </h2>
              ...
              <div className="bg-white border border-[#E0DEF5] rounded-xl p-6 shadow-[0_2px_12px_rgba(26,19,64,0.04)] space-y-4">
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-3 mb-2">
                  <Settings size={18} className="text-[#2D2380]" /> Layout & Page Sections
                </h2>
                ...
                <div className="grid grid-cols-1 gap-2">
                  {[
                    ...
                    <label
                      key={name}
                      className="flex items-center justify-between bg-[#F7F6FF] border border-[#E0DEF5] rounded-md px-3 py-2 text-[13px] font-semibold text-[#1A1340] cursor-pointer"
                    >
                      {label}
                      <input
                        type="checkbox"
              ...
              <div className="bg-white border border-[#E0DEF5] rounded-xl p-6 shadow-[0_2px_12px_rgba(26,19,64,0.04)] space-y-4">
                <h2 className="text-[16px] font-bold text-[#1A1340] flex items-center gap-2 border-b border-[#E0DEF5] pb-3 mb-2">
                  <FileText size={18} className="text-[#2D2380]" /> SEO Settings
                </h2>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleBasicChange}
                    maxLength={70}
                    placeholder="e.g. Herman Miller Embody Review & Deals"
                    className="w-full px-3 py-2 bg-white border border-[#E0DEF5] rounded-md text-[13px] focus:border-[#2D2380] outline-none"
                  />
                </div>
...
export default NewAffiliateProductEditor;